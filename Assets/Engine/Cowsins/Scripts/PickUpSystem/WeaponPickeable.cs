...
namespace cowsins
{
    public partial class WeaponPickeable : Pickeable
    {
        ...
        public override CustomSaveData SaveFields()
        {
            ...
            // Save attachments
            saveData.savedFields["barrel"] = currentAttachments[AttachmentType.Barrel]?.name;
            saveData.savedFields["scope"] = currentAttachments[AttachmentType.Scope]?.name;
            saveData.savedFields["stock"] = currentAttachments[AttachmentType.Stock]?.name;
            saveData.savedFields["grip"] = currentAttachments[AttachmentType.Grip]?.name;
            saveData.savedFields["magazine"] = currentAttachments[AttachmentType.Magazine]?.name;
            saveData.savedFields["flashlight"] = currentAttachments[AttachmentType.Flashlight]?.name;
            saveData.savedFields["laser"] = currentAttachments[AttachmentType.Laser]?.name;
